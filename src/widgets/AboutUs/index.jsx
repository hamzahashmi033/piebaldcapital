...
const About = () => {
    return (
        <section className="relative bg-[#f0eee8] pb-5 about-bg">
            ...
            <div className='w-[90%] m-auto pt-26 flex justify-around p-10'>
                <div className="w-[25%]">
                ...
                <div className="relative w-[33%]  border border-r-3 border-l-0 border-t-6  border-b-0 border-[#c86e3b]  p-6 rounded-lg" >
                    ...
                    <div class="relative z-10 mt-10 space-y-2">
                        <p class="text-lg  text-black leading-tight">
            ...
            <div className='w-[90%] m-auto mt-5 flex justify-between p-10'>
                ...
                <div className="relative w-[100%] flex gap-12 border border-r-3 border-l-0 border-t-6  border-b-0 border-[#c86e3b]  p-6 rounded-lg">



                    <div class="relative text-center w-[32%] z-10 mt-10 space-y-2">
                        <BadgeCheck className="text-black h-8 w-8 m-auto" />
                        <h3 className='text-[16px] font-bold'>Service excellence</h3>
                        <p class="text-[12px]  text-black leading-tight">
                            Rigorous processes and commitment to exceed client expectations.

                        </p>
                    </div>
                    <div class="relative w-[32%] text-center z-10 mt-10 space-y-2 ">
                        <ShieldCheck className="text-black h-8 w-8 m-auto" />
                        <h3 className='text-[16px] font-bold'>Trustworthiness</h3>
                        <p class="text-[12px]  text-black leading-tight">
                       ...
                       <div class="relative text-center w-[32%] z-10 mt-10 space-y-2">
                        ...
                        <h3 className='text-[16px] font-bold'>Social responsibility</h3>
                        <p class="text-[12px]  text-black leading-tight">
                    ...
                    <div class="relative text-center w-[32%] z-10 mt-10 space-y-2">
                        ...
                        <h3 className='text-[16px] font-bold'>Accountability</h3>
                        <p class="text-[12px]  text-black leading-tight">
